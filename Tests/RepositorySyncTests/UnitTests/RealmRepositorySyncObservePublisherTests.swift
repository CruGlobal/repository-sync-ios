//
//  RealmRepositorySyncObservePublisherTests.swift
//  RepositorySync
//
...
extension RealmRepositorySyncObservePublisherTests {
    
    private func getSharedRealmDatabase(addObjects: [MockRealmObject], shouldDeleteExistingObjects: Bool) throws -> RealmDatabase {
        let directoryName: String = "realm_\(String(describing: RealmRepositorySyncObservePublisherTests.self))"
