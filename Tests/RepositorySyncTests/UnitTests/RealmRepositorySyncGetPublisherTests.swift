//
//  RealmRepositorySyncGetPublisherTests.swift
//  RepositorySync
//
...
@Suite(.serialized)
struct RealmRepositorySyncGetPublisherTests {
...
extension RealmRepositorySyncGetPublisherTests {
    
    private func getSharedRealmDatabase(addObjects: [MockRealmObject], shouldDeleteExistingObjects: Bool) throws -> RealmDatabase {
        let directoryName: String = "realm_\(String(describing: RealmRepositorySyncGetPublisherTests.self))"
