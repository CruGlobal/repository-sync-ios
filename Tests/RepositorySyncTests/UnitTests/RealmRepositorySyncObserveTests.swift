//
//  RealmRepositorySyncObserveTests.swift
//  RepositorySync
//
...
@Suite(.serialized)
struct RealmRepositorySyncObserveTests {
    ...
    @MainActor func realmObserveReturnCacheDataDontFetchWillTriggerOnceWithAllObjects(argument: TestArgument) async throws {
    ...
    @MainActor func realmObserveReturnCacheDataDontFetchWillTriggerTwiceWithAllObjectsAndOnSecondaryExternalFetch(argument: TestArgument) async throws {
    ...
    @MainActor func realmObserveReturnCacheDataDontFetchWillTriggerOnceWithObject(argument: TestArgument) async throws {
    ...
    @MainActor func realmObserveReturnCacheDataDontFetchWillTriggerTwiceWithObjectAndOnSecondaryExternalDataFetch(argument: TestArgument) async throws {
    ...
    @MainActor func realmObserveReturnCacheDataElseFetchIsTriggeredTwiceWhenNoCacheDataExistsAndOnExternalDataFetch(argument: TestArgument) async throws {
    ...
    @MainActor func realmObserveReturnCacheDataElseFetchIsTriggeredThreeTimesWithCachedObjectsAndExternalDataFetchAndOnSecondaryExternalDataFetch(argument: TestArgument) async throws {
    ...
    @MainActor func realmObserveReturnCacheDataElseFetchIsTriggeredTwiceWithCachedObjectsAndOnSecondaryExternalDataFetch(argument: TestArgument) async throws {
    ...
    @MainActor func realmObserveReturnCacheDataElseFetchIsTriggeredTwiceWithCachedObjectAndExternalDataFetch(argument: TestArgument) async throws {
    ...
    @MainActor func realmObserveReturnCacheDataElseFetchIsTriggeredThreeTimesWithCachedObjectAndExternalDataFetchAndOnSecondaryExternalDataFetch(argument: TestArgument) async throws {
    ...
    @MainActor func realmObserveReturnCacheDataElseFetchIsTriggeredTwiceWithCachedObjectAndOnSecondaryExternalDataFetch(argument: TestArgument) async throws {
    ...
    @MainActor func realmObserveReturnCacheDataAndFetchWillTriggerOnceWhenNoExternalDataExists(argument: TestArgument) async throws {
    ...
    @MainActor func realmObserveReturnCacheDataAndFetchWillTriggerTwiceWhenExternalDataExists(argument: TestArgument) async throws {
    ...
    @MainActor func realmObserveReturnCacheDataAndFetchWillTriggerThreeTimesOnceForInitialCacheDataForExternalDataFetchAndSecondaryExternalDataFetch(argument: TestArgument) async throws {
...
extension RealmRepositorySyncObserveTests {
    
    private func getSharedRealmDatabase(addObjects: [MockRealmObject], shouldDeleteExistingObjects: Bool) throws -> RealmDatabase {
        let directoryName: String = "realm_\(String(describing: RealmRepositorySyncObserveTests.self))"
